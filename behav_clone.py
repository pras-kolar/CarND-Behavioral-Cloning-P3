...
with open('/home/workspace/orig_data/data/driving_log.csv') as csvfile:
...
for line in lines:
    ...
    current_path = '/home/workspace/orig_data/data/IMG' + filename
    image_path = '/home/workspace/orig_data/data/IMG'
...
#X_train.reshape([-1, 20625, 1])
#X_train = X_train.reshape(X_train.shape[0], 20625, 1)
...
model.save('sim_3cam_0808_good.h5')
